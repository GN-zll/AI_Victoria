...
create_protocol("../final_texts/Formal", {"formal" : True, "timecodes" : True, "discussion_context" : True, "list_of_orders" : True})
create_protocol("../final_texts/Informal", {"formal" : False, "timecodes" : True, "discussion_context" : True, "list_of_orders" : True})
